...
class Profile extends PureComponent {
    ...
    render() {
        const { currentUser: { coverPhoto, profilePhoto, name }, uploadProfile, uploadCover } = this.props
        ...
        const AddIcon = () => (
            <svg width="64" height="64" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                viewBox="0 0 512 512"  >
                <g>
                ...
                <div className="container profile-container">
                    <div className="info">
                        ...
                        <div className='profile-photo'>
                            {profilePhoto ? <img src={profilePhoto} alt="Profile" /> : <AddIcon />}
                        </div>
                        <div className="update-btn">
                            <button className='update-profile'>
                                <label htmlFor="profile-photo">Set Profile Photo</label>
                            </button>
                            <input onChange={uploadProfilePhoto} style={{ display: 'none' }} type="file" name="profilePhoto" id="profile-photo" />
                            <button className='update-cover'>
                                <label htmlFor="cover-photo">Set Cover Photo</label>
                            </button>
                            <input onChange={uploadCoverPhoto} style={{ display: 'none' }} type="file" name="coverPhoto" id="cover-photo" />
                        </div>
